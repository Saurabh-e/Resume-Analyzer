      ...
      <section className="w-full lg:w-1/2 min-h-screen flex items-center justify-center p-6 relative z-10">
        ...
        >
          ...
          <div className="text-center lg:text-left space-y-1">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-on-surface dark:text-white font-display">Welcome Back</h2>
            <p className="text-sm text-on-surface-variant dark:text-slate-400">Sign in to access your AI-powered career dashboard.</p>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit} noValidate>
            ...
            <div>
              ...
              <div className={`flex items-center border-b-2 ${errors.email ? 'border-error' : 'border-outline-variant/30 dark:border-slate-800 focus-within:border-primary'} transition duration-300`}>
                ...
                <input 
                  ...
                  className="w-full bg-transparent border-none focus:ring-0 py-2.5 text-sm text-on-surface dark:text-white placeholder:text-on-surface-variant/40 outline-none"
                  placeholder="name@company.com" 
                />
              </div>
              {errors.email && (
                <p className="text-xs text-error mt-1.5 font-semibold">{errors.email}</p>
              )}
            </div>
            ...
            <div className="relative">
              <div className="flex justify-between items-end mb-1">
                <label className="block text-xs font-bold text-on-surface dark:text-slate-300 uppercase tracking-wider">
                  Password
                </label>
                <Link to="#" className="text-xs font-semibold text-primary dark:text-primary-400 hover:underline">
                  Forgot password?
                </Link>
              </div>
              ...
              {errors.password && (
                <p className="text-xs text-error mt-1.5 font-semibold">{errors.password}</p>
              )}
            </div>
            ...
            <button 
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-br from-primary-container to-primary text-on-primary font-bold text-sm py-4 rounded-xl shadow-lg hover:shadow-xl hover:translate-y-[-2px] active:scale-95 transition-all duration-300 flex justify-center items-center"
            >
              {loading ? (
          ...
          <div className="text-center">
            <p className="text-sm text-on-surface-variant dark:text-slate-400">
              ...
              <Link to="/register" className="text-primary dark:text-primary-400 font-bold ml-1 hover:underline underline-offset-4">
                Create Account
              </Link>
            </p>
          </div>
